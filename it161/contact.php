...
<html lang="en">
 <head>
  <title>Shelby Holmes: Contact Form</title>
 ...
 <body>
     <header>
     <h1>Shelby Holmes: Contact Form</h1>
     <nav class="topnav" id="myTopnav">
       ...
       <a href="contact.php" class="active">Contact Shelby</a>
   ...
   <div class="wrapper">
       ...
       <h2 class="subheader">Contact Shelby</h2>
       ...
       <?php
        ...
        $toName = "Shelby"; //place your client's name here
	...
	?>
     ...
     <footer>
      <p><small>&copy; 2021 by 
          <a href="contact.php">Shelby Holmes</a>, All Rights Reserved ~ 
